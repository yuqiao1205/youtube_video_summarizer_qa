    ...
    <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-200">
      ...
      <form onSubmit={handleSearch} className="flex gap-3">
        <input
          ...
          className="flex-1 px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
        <button
          type="submit"
